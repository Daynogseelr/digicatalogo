...
<div class="row text-center"> 
    @if ($status == 'RECIBIDO' || $status == 'REVISIÓN')
        <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4"style="padding:0;">  
            <a style="margin: -6px !important; padding: 5px;"  href="javascript:void(0)" data-toggle="tooltip" onClick="mostrarService({{ $id }})" title="Edit" class="edit btn btn-primary disabled"> 
                <i class="fa-regular fa-pen-to-square"></i>
            </a>
        </div> 
    @else
        <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4"style="padding:0;">  
            <a style="margin: -6px !important; padding: 5px;"  href="javascript:void(0)" data-toggle="tooltip" onClick="mostrarService({{ $id }})" title="Edit" class="edit btn btn-primary "> 
                <i class="fa-regular fa-pen-to-square"></i>
            </a>
        </div> 
    @endif
