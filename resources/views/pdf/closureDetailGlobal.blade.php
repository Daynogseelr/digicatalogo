...
<head>
    <meta charset="UTF-8">
    <title>Cierre Global Detallado</title>
    <style>
...
<body>
    ...
    <h3 style="text-align: center;">CAJA CHICA</h3>
    <table>
        <tr>
            <td colspan="4" style="text-align: right;"><b>Total Caja Chica:</b></td>
            <td style="text-align: right;"><b>{{ number_format($smallBox,2) }}</b></td>
        </tr>
    </table>
